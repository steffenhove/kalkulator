...
// --- HJELPEFUNKSJONER FOR HISTORYSCREEN ---
...
fun getDimensionsText(form: String, dimensions: String, thickness: Double, unit: String): String {
    ...
    return when (form) {
        ...
        // Antar "Trapes" her er en generell firkantet plate
...
fun formatLargeNumber(number: Double): String {
    // Bruker java.text.DecimalFormat for å unngå vitenskapelig notasjon
